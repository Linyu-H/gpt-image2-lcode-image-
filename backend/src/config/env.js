...
const corsOrigins = (process.env.CORS_ORIGINS || `${frontendBaseUrl},http://localhost:5173,http://127.0.0.1:5173,http://[::1]:5173,http://localhost:5174,http://127.0.0.1:5174,http://[::1]:5174`)
  .split(',')
